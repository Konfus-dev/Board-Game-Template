...
v1.48
Updated the Book builder so make it compatible with Unitys new Render Pipelines. There is now an option for the Shader Texture name so you can control which texture is set by the Book Builder. Change to _BaseMap for non Standard pipelines.
